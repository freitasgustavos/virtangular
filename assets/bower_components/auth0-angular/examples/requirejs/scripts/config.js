require.config({
    paths: {
        ...
        'angular-jwt':     '//cdn.rawgit.com/auth0/angular-jwt/master/dist2/angular-jwt',
        'angular-storage': '//cdn.rawgit.com/auth0/angular-storage/master/dist2/angular-storage',
