...
(function() {
  ...
  */
  ...
  //dist2 = how far away from the mouse to place tooltip
...
nv.models.distribution = function() {
  ...
  function chart(selection) {
    selection.each(function(data) {
      ...
      var distWrap = g.selectAll('g.nv-dist2')
          .data(function(d) { return d }, function(d) { return d.key });

      distWrap.enter().append('g');
      distWrap
          .attr('class', function(d,i) { return 'nv-dist2 nv-series-' + i })
          .style('stroke', function(d,i) { return color(d, i) });

      var dist = distWrap.selectAll('line.nv-dist2' + axis)
          .data(function(d) { return d.values })
      dist.enter().append('line')
          .attr(axis + '1', function(d,i) { return scale0(getData(d,i)) })
          .attr(axis + '2', function(d,i) { return scale0(getData(d,i)) })
      distWrap.exit().selectAll('line.nv-dist2' + axis)
          .transition()
          ...
          .remove();
      dist
          .attr('class', function(d,i) { return 'nv-dist2' + axis + ' nv-dist2' + axis + '-' + i })
          .attr(naxis + '1', 0)
          .attr(naxis + '2', size);
      dist
          .transition()
