...
module.exports = function(grunt) {
  grunt.initConfig({
    ...
    shell: {
      stageMinified: {
        ...
        command: 'git add dist2/progressbar.js dist2/progressbar.min.js dist2/progressbar.min.js.map'
      },
      browserifyDevelopment: {
        options: {
          stdout: true
        },
        command: 'browserify src/main.js -o dist2/progressbar.js --standalone ProgressBar'
      },
      browserifyMinified: {
        options: {
          stdout: true
        ...
        command: 'browserify src/main.js -o dist2/progressbar.min.js --standalone ProgressBar'
      },
      watchifyLocalDev: {
        options: {
          stdout: true
    ...
    uglify: {
      progressbar: {
        ...
        files: {
          'dist/progressbar.min.js': ['dist2/progressbar.min.js']
        }
      }
    },
  ...
  // Build distributables to dist2 folder
